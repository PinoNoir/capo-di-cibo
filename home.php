...
<body>
  ...
  <section class="main-content">
        ...
        <div class="col s12 m6 l4">
          <div class="card small">
            ...
            <div class="card-content">
              ...
              <p><a class="product-link" href="products.php">Browse Pastas</a></p>
            </div>
        ...
        <div class="col s12 m6 l4">
          <div class="card small">
            ...
            <div class="card-content">
              ...
              <p><a class="product-link" href="products.php">Browse Sauces</a></p>
            </div>
        ...
        <div class="col s12 m6 l4">
          <div class="card small">
            ...
            <div class="card-content">
              ...
              <p><a class="product-link" href="products.php">Browse Cheeses</a></p>
            </div>
    ...
    <div class="container-card-panel">
      <hr class="style1">
      <div class="row">
        <h1 class="featured center-align">20% Off All Premium Pasta Sauces</h1>
